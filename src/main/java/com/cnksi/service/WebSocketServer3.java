 ...
 **/
@Slf4j
@ServerEndpoint(value = "/websocket3")
@Component
public class WebSocketServer3 {
	...
	private static CopyOnWriteArraySet<WebSocketServer3> webSocketSet = new CopyOnWriteArraySet<>();
	...
	public void onMessage(String message, Session session) {
		...
		// 群发消息
		for (WebSocketServer3 item : webSocketSet) {
			try {
